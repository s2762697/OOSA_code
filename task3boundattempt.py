...
filename = '/geos/netdata/oosa/assignment/lvis/2009/ILVIS1B_AQ2009_1020_R1408_058456.h5'  #only.h5 files
                ...
                if tile_midy > -300000:
                    if tile_midx > -1600000:
                        if tile_midy < -200000:
                            ...
                            lvis.estimateGround()
                            tiffName = f"Data2009/DEM{filename}|{tile_number}.tif"   #filename with tile identifier
